...
const ResetPassword = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await apiRquest({
        url: "/users/request-passwordrest",
        method: "POST",
        data: data,
      });
  ...
  return (
    <div className="w-full h-[100vh] bg-[#FFFAF0] flex items-center justify-center p-6">
      <div className="bg-[#FFFAF0] w-full md:w-1/3 2xl:w-1/4 px-6 py-8 shadow-md rounded-lg">
